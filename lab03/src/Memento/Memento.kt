...
// Memento — снимок состояния корзины
class CartMemento(val state: List<String>)

// Originator — корзина покупок
class ShoppingCart {
...
// Caretaker — управление историей состояний
class CartHistory {
...
//
// Таким образом, многоуровневая отмена работает через стек memento,
// но следует учитывать ресурсы памяти и стоимость копирования состояния.
